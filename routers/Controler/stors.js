...
const addCart = async(req,res)=>{
  ...
  const user = req.token.userId;
  try {
   const newCart=await userModel.findOneAndUpdate({ _id:user }, { $push: { cart:id } },{
      new: true
    })
...
module.exports = { getStore, postStore, addComment,getproduct,addCart,getCart ,removeCart};
